...
export default async function handler(_req, res) {
  const out = {
    ...
    // Which build is actually serving. Three rounds were spent wondering
    // whether a fix was live; Vercel supplies this, so there is no reason to
    // guess. VERCEL_GIT_COMMIT_SHA and friends are set automatically.
    deployment: {
